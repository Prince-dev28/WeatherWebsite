...
let cityInput = document.getElementById('city_input'),
    ...
    api_key = '43796730b3f715239778c7f42cc6b5b6',
...
function getWeatherDetails(name, lat, lon, country, state) {
    ...
    fetch(WEATHER_API_URL)
        ...
        .then(data => {
            ...
            {speed} = data.wind,
            sRiseTime = moment.unix(sunrise + data.timezone).utc().format('hh:mm A'),
            sSetTime = moment.unix(sunset + data.timezone).utc().format('hh:mm A');
